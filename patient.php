            ...
            <div class="rounded-2xl border border-slate-200/80 bg-gradient-to-br from-slate-50 to-white p-6 shadow-sm">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3.5 text-sm text-slate-600">
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        ...
                        <dd class="font-bold text-slate-900 prevent-overflow"><?= $formatValue($patient['full_name'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Nombre preferido</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['preferred_name'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Documento</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['document_id'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Fecha de nacimiento</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= htmlspecialchars($birthDateDisplay) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Edad</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $patient['age'] ? (int) $patient['age'] . ' años' : '—' ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Género</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['gender'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Estado civil</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['marital_status'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 border-b border-slate-200/60 pb-3">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Ocupación</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['occupation'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1 md:col-span-2">
                        <dt class="font-semibold text-slate-500 text-xs uppercase tracking-wide">Dirección</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['address'] ?? null) ?></dd>
                    </div>
                </dl>
            </div>
                ...
                <div class="rounded-2xl border border-blue-200/60 bg-gradient-to-br from-blue-50/50 to-white p-5 shadow-sm">
                    ...
                    <dl class="space-y-3 text-sm text-slate-600">
                        <div class="flex flex-col gap-1">
                            ...
                            <dd class="break-words font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['email'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-slate-500 text-xs uppercase">Tel. principal</dt>
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['phone_primary'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-slate-500 text-xs uppercase">Tel. alterno</dt>
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['phone_secondary'] ?? null) ?></dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="rounded-2xl border border-red-200/60 bg-gradient-to-br from-red-50/50 to-white p-5 shadow-sm">
                    ...
                    <dl class="space-y-3 text-sm text-red-900">
                        <div class="flex flex-col gap-1">
                            ...
                            <dd class="font-medium prevent-overflow"><?= $formatValue($patient['emergency_contact'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-red-600 text-xs uppercase">Parentesco</dt>
                            <dd class="font-medium prevent-overflow"><?= $formatValue($patient['emergency_contact_relationship'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-red-600 text-xs uppercase">Teléfono</dt>
                            <dd class="font-medium prevent-overflow"><?= $formatValue($patient['emergency_contact_phone'] ?? null) ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
                ...
                <div class="rounded-2xl border border-purple-200/60 bg-gradient-to-br from-purple-50/50 to-white p-5 shadow-sm">
                    ...
                    <dl class="space-y-3 text-sm text-slate-600">
                        <div class="flex flex-col gap-1">
                            ...
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['representative_name'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-slate-500 text-xs uppercase">Documento</dt>
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['representative_document'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-slate-500 text-xs uppercase">Teléfono</dt>
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['representative_phone'] ?? null) ?></dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="rounded-2xl border border-teal-200/60 bg-gradient-to-br from-teal-50/50 to-white p-5 shadow-sm">
                    ...
                    <dl class="space-y-3 text-sm text-slate-600">
                        <div class="flex flex-col gap-1">
                            ...
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['referred_by'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-slate-500 text-xs uppercase">Médico tratante</dt>
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['primary_physician'] ?? null) ?></dd>
                        </div>
                        <div class="flex flex-col gap-1">
                            <dt class="font-semibold text-slate-500 text-xs uppercase">Tel. del médico</dt>
                            <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['primary_physician_phone'] ?? null) ?></dd>
                        </div>
                    </dl>
                </div>
            </div>
            ...
            <div class="rounded-2xl border border-indigo-200/60 bg-gradient-to-br from-indigo-50/50 to-white p-5 shadow-sm">
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-600">
                    <div class="flex flex-col gap-1">
                        ...
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['insurance_provider'] ?? null) ?></dd>
                    </div>
                    <div class="flex flex-col gap-1">
                        <dt class="font-semibold text-slate-500 text-xs uppercase">N.º de póliza</dt>
                        <dd class="font-medium text-slate-700 prevent-overflow"><?= $formatValue($patient['insurance_policy_number'] ?? null) ?></dd>
                    </div>
                </dl>
            </div>
        </div>
...
<section class="rounded-3xl bg-white/95 p-6 shadow-sm shadow-slate-200/60 ring-1 ring-slate-200/70 sm:p-8 space-y-6" id="historia">
    ...
    <?php else: ?>
        <div class="historia-clinica-masonry">
            <div class="rounded-2xl border border-slate-200/80 bg-slate-50/60 p-4">
                ...
                <dl class="space-y-3 text-sm text-slate-600">
                    <div class="border-b border-slate-200/60 pb-2">
                        ...
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['consultation_reason'] ? nl2br(htmlspecialchars($profile['consultation_reason'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Evolución / enfermedad actual</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['current_condition'] ? nl2br(htmlspecialchars($profile['current_condition'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Alertas clínicas</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['medical_alerts'] ? nl2br(htmlspecialchars($profile['medical_alerts'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Medicación actual</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['medications'] ? nl2br(htmlspecialchars($profile['medications'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Hospitalizaciones / procedimientos</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['hospitalizations'] ? nl2br(htmlspecialchars($profile['hospitalizations'])) : '—' ?></dd>
                    </div>
                </dl>
            </div>
            <div class="rounded-2xl border border-slate-200/80 bg-white p-4">
                ...
                <div class="mt-3 space-y-3 text-sm text-slate-600">
                    <div class="border-b border-slate-200/60 pb-2">
                        ...
                        <p class="historia-clinica-text-scrollable text-slate-600"><?= $profile['family_history'] ? nl2br(htmlspecialchars($profile['family_history'])) : '—' ?></p>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <h4 class="mb-1 text-xs font-semibold text-slate-700">Hábitos</h4>
                        <p class="historia-clinica-text-scrollable text-slate-600"><?= $profile['habits'] ? nl2br(htmlspecialchars($profile['habits'])) : '—' ?></p>
                    </div>
                </div>
            </div>
            <div class="rounded-2xl border border-slate-200/80 bg-white p-4">
                ...
                <dl class="space-y-3 text-sm text-slate-600">
                    <div class="border-b border-slate-200/60 pb-2">
                        ...
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['extraoral_exam'] ? nl2br(htmlspecialchars($profile['extraoral_exam'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Examen intraoral</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['intraoral_exam'] ? nl2br(htmlspecialchars($profile['intraoral_exam'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Tejidos periodontales</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['periodontal_status'] ? nl2br(htmlspecialchars($profile['periodontal_status'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                    ...
                    <div class="border-b border-slate-200/60 pb-2">
                        ...
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['risk_assessment'] ? nl2br(htmlspecialchars($profile['risk_assessment'])) : '—' ?></dd>
                    </div>
                </dl>
            </div>
            <div class="rounded-2xl border border-slate-200/80 bg-slate-50/60 p-4">
                ...
                <dl class="space-y-3 text-sm text-slate-600">
                    <div class="border-b border-slate-200/60 pb-2">
                        ...
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['diagnosis'] ? nl2br(htmlspecialchars($profile['diagnosis'])) : '—' ?></dd>
                    </div>
                    <div class="border-b border-slate-200/60 pb-2">
                        <dt class="mb-1 text-xs font-semibold text-slate-700">Plan de tratamiento</dt>
                        <dd class="historia-clinica-text-scrollable text-slate-600"><?= $profile['treatment_plan'] ? nl2br(htmlspecialchars($profile['treatment_plan'])) : '—' ?></dd>
                    </div>
                </dl>
            </div>
            <div class="rounded-2xl border border-slate-200/80 bg-white p-4">
            ...
            <div class="rounded-2xl border border-slate-200/80 bg-white p-4">
                ...
                <?php if ($patientStudies): ?>
                    ...
                    <ul class="estudios-list-scrollable space-y-3 text-sm text-slate-600">
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <?php if ($notes !== ''): ?>
                                        <div class="text-xs text-slate-600">
                                            ...
                                            <p class="prevent-overflow mt-1 max-h-20 overflow-x-auto overflow-y-auto rounded border border-slate-200 bg-slate-50 p-2 text-xs" style="word-wrap: break-word; overflow-wrap: break-word;">
                        ...
                        <li class="rounded-2xl border border-slate-200/80 bg-slate-50/70 p-4">
                            ...
                            <div class="mt-3 space-y-2 text-sm text-slate-600">
                                <?php if ($visit['subjective_notes']): ?>
                                    <p class="prevent-overflow"><span class="font-semibold text-slate-700">S:</span> <?= nl2br(htmlspecialchars($visit['subjective_notes'])) ?></p>
                                <?php endif; ?>
                                <?php if ($visit['objective_notes']): ?>
                                    <p class="prevent-overflow"><span class="font-semibold text-slate-700">O:</span> <?= nl2br(htmlspecialchars($visit['objective_notes'])) ?></p>
                                <?php endif; ?>
                                <?php if ($visit['assessment']): ?>
                                    <p class="prevent-overflow"><span class="font-semibold text-slate-700">A:</span> <?= nl2br(htmlspecialchars($visit['assessment'])) ?></p>
                                <?php endif; ?>
                                <?php if ($visit['plan']): ?>
                                    <p class="prevent-overflow"><span class="font-semibold text-slate-700">P:</span> <?= nl2br(htmlspecialchars($visit['plan'])) ?></p>
                                <?php endif; ?>
                                <?php
                                $vitalTokens = [];
                        ...
                        <tbody class="divide-y divide-slate-100 bg-white">
                            <?php foreach ($activities as $activity): ?>
                                ...
                                <tr class="hover:bg-slate-50/80">
                                    ...
                                    <td class="px-4 py-4 text-sm text-slate-700 prevent-overflow">
                                        <?= nl2br(htmlspecialchars($activityDescription)) ?>
                                        <?php if ($activityNotes !== ''): ?>
                                            <p class="mt-2 text-xs text-slate-500 prevent-overflow"><?= nl2br(htmlspecialchars($activityNotes)) ?></p>
                                        <?php endif; ?>
                                    </td>
